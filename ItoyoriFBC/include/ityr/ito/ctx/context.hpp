/**
 * @file context.hpp
 * @brief Architecture-dependent context management for stackful coroutines and context switching.
 *
 * This header provides the interface and architecture-specific implementations for managing
 * execution contexts, including saving, resuming, and switching stacks. It supports both x86_64
 * and aarch64 architectures, selecting the appropriate implementation at compile time.
 *
 * The main types defined are:
 *   - ityr::ito::context_frame: Represents a saved execution context frame.
 *   - ityr::ito::context: Provides static methods for context manipulation, such as saving the
 *     current context, resuming a saved context, and executing functions on alternate stacks.
 */
...
#include "ityr/ito/ctx/x86_64.hpp"
namespace ityr::ito {
...
#include "ityr/ito/ctx/aarch64.hpp"
namespace ityr::ito {
